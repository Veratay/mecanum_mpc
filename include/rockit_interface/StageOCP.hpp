...
namespace fatrop
{
    ...
    */ 
    ...
    class StageOCP : public fatrop::OcpAbstract
    {
    public:
        ...
        fatrop_int get_n_stage_params(const fatrop_int k) const ;
    ...
    public:
        ...
        fatrop_int get_default_stage_params(double *stage_params_res, const fatrop_int k) const 
        {
        ...
        fatrop_int get_default_global_params(double *global_params_res) const 
        {
