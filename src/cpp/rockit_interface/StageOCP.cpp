                               ...
                               const fatrop_int k)
{
    ...
    args[1] = inputs_k;
    args[2] = states_k;
    args[3] = stage_params.data() + k*n_stage_params_;
    args[4] = global_params.data();
                                 ...
                                 const fatrop_int k)
{
    ...
    args[4] = lam_eq_k;
    args[5] = lam_ineq_k;
    args[6] = stage_params.data() + k*n_stage_params_;
    args[7] = global_params.data();
    if (k == 0)
    ...
    const fatrop_int k)
{
    ...
    args[0] = inputs_k;
    args[1] = states_k;
    args[2] = stage_params.data() + k*n_stage_params_;
    args[3] = global_params.data();
    if (k == K_ - 1)
    ...
    const fatrop_int k)
{
    if (k == K_ - 1)
    {
        const double *args[3];
        args[0] = states_k;
        args[1] = stage_params.data() + k*n_stage_params_;
        args[2] = global_params.data();
